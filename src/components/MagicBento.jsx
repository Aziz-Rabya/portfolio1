...
// Updated cardData with only 3 cards
const cardData = [
  { 
    title: "WEB DEVELOPER", 
    color: '#0000', 
...
const BentoCardGrid = ({ children, gridRef }) => (
  <div
    className="bento-section w-full max-w-6xl mx-auto px-4 select-none relative"
    ref={gridRef}
  >
    {children}
  </div>
      ...
      <style>
        {`
          ...
          .card {
            ...
            background: rgba(6, 0, 16, 0.8); /* Slightly transparent background */
          ...
          .card:hover {
            ...
            border-color: #d1d5db; /* Slightly darker gray on hover */
          }
          ...
          .card-image {
            ...
            object-fit: contain;
            margin-bottom: 1rem;
            /* Removed background, border, padding, and border-radius */
          }
          ...
          .card__label {
            ...
            border-radius: 20px;
            font-size: 0.8rem;
            border: 1px solid #e5e7eb; /* Light gray border for labels */
        ...
        <div className="card-grid">
          {cardData.map((card, index) => {
            ...
            return (
              ...
              >
                {/* Added image rendering for non-particle cards */}
                <div className="card__header flex flex-col gap-3 relative text-white">
                  <img 
                    src={card.image} 
                    alt={card.title}
